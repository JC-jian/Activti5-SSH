    ...
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <tbody id="TableData" class="dataContainer" datakey="formList">
			...
			<tr align="CENTER" class="TableDetail1 template">
				...
				&nbsp;</td>
				<td><a href="${pageContext.request.contextPath}/flowAction_approveUI.action?taskId=${task.id}&applicationId=${application.id}">审批处理</a>
					<a href="${pageContext.request.contextPath}/flowAction_approveInfoList.action?applicationId=${application.id}">查看流转记录</a>
				</td>
			</tr>
			</s:iterator>
