...
<!--显示表单内容-->
<div id=MainArea>
    <form action="${pageContext.request.contextPath}/flowAction_submit" enctype="multipart/form-data" method="post">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
					<tr>
						<td><a href="${pageContext.request.contextPath}/templateAction_download.action?id=${templateId}" style="text-decoration: underline">[点击下载文档模板文件]</a></td>
					</tr>
                </table>
            </div>
        </div>
